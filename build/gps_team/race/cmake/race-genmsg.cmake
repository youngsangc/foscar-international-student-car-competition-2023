...
set(MSG_I_FLAGS "-Irace:/home/youngsangcho/ISCC_2023/src/gps_team/race/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/drive_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/drive_values.msg" ""
)

get_filename_component(_filename "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/test.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/test.msg" ""
)

get_filename_component(_filename "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/enc_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/enc_values.msg" ""
)

get_filename_component(_filename "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/mode.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/mode.msg" ""
)

get_filename_component(_filename "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/lane_info.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/youngsangcho/ISCC_2023/src/gps_team/race/msg/lane_info.msg" ""
)
