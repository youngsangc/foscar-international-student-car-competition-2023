...
if(NOT "/home/youngsangcho/ISCC_2023/devel/include;/home/youngsangcho/ISCC_2023/src/lidar_team/track_race/include " STREQUAL " ")
  set(track_race_INCLUDE_DIRS "")
  set(_include_dirs "/home/youngsangcho/ISCC_2023/devel/include;/home/youngsangcho/ISCC_2023/src/lidar_team/track_race/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'track_race' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/youngsangcho/ISCC_2023/src/lidar_team/track_race/${idir}'.  ${_report}")
    endif()
