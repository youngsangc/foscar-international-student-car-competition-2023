...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waypoint_maker-msg:<Waypoint> is deprecated: use waypoint_maker-msg:Waypoint instead.")))

(cl:ensure-generic-function 'cnt-val :lambda-list '(m))
(cl:defmethod cnt-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_maker-msg:cnt-val is deprecated.  Use waypoint_maker-msg:cnt instead.")
  (cnt m))

(cl:ensure-generic-function 'x_arr-val :lambda-list '(m))
(cl:defmethod x_arr-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_maker-msg:x_arr-val is deprecated.  Use waypoint_maker-msg:x_arr instead.")
  (x_arr m))

(cl:ensure-generic-function 'y_arr-val :lambda-list '(m))
(cl:defmethod y_arr-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_maker-msg:y_arr-val is deprecated.  Use waypoint_maker-msg:y_arr instead.")
  (y_arr m))
