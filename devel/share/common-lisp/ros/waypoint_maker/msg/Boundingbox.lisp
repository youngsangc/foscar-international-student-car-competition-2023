...
(cl:defmethod cl:initialize-instance :after ((m <Boundingbox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Boundingbox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waypoint_maker-msg:<Boundingbox> is deprecated: use waypoint_maker-msg:Boundingbox instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_maker-msg:x-val is deprecated.  Use waypoint_maker-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_maker-msg:y-val is deprecated.  Use waypoint_maker-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_maker-msg:z-val is deprecated.  Use waypoint_maker-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'volume-val :lambda-list '(m))
(cl:defmethod volume-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_maker-msg:volume-val is deprecated.  Use waypoint_maker-msg:volume instead.")
  (volume m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_maker-msg:distance-val is deprecated.  Use waypoint_maker-msg:distance instead.")
  (distance m))
