...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /home/youngsangcho/ISCC_2023/src/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /home/youngsangcho/ISCC_2023/devel)
  ...
  set(velodyne_driver_INSTALL_PREFIX /home/youngsangcho/ISCC_2023/install)
...
if(NOT "/home/youngsangcho/ISCC_2023/devel/include;/home/youngsangcho/ISCC_2023/src/velodyne/velodyne_driver/include " STREQUAL " ")
  set(velodyne_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/youngsangcho/ISCC_2023/devel/include;/home/youngsangcho/ISCC_2023/src/velodyne/velodyne_driver/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/youngsangcho/ISCC_2023/src/velodyne/velodyne_driver/${idir}'.  ${_report}")
    endif()
