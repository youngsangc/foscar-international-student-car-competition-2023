...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_laserscan_SOURCE_PREFIX /home/youngsangcho/ISCC_2023/src/velodyne/velodyne_laserscan)
  set(velodyne_laserscan_DEVEL_PREFIX /home/youngsangcho/ISCC_2023/devel)
  ...
  set(velodyne_laserscan_INSTALL_PREFIX /home/youngsangcho/ISCC_2023/install)
...
if(NOT "/home/youngsangcho/ISCC_2023/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/youngsangcho/ISCC_2023/src/velodyne/velodyne_laserscan/${idir}'.  ${_report}")
    endif()
