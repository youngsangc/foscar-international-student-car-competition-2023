...
struct EsfRAW_
{
  ...
  _reserved0_type reserved0;
   ...
   typedef std::vector< ::ublox_msgs::EsfRAW_Block_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ublox_msgs::EsfRAW_Block_<ContainerAllocator> >> _blocks_type;
  _blocks_type blocks;
