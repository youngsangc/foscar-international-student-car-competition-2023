...
struct RxmSVSI_
{
  ...
  _numSV_type numSV;
   ...
   typedef std::vector< ::ublox_msgs::RxmSVSI_SV_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ublox_msgs::RxmSVSI_SV_<ContainerAllocator> >> _sv_type;
  _sv_type sv;
