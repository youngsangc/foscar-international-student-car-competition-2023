...
class Yolov7Publisher:
    def __init__(self, image2: str, weights: str, conf_thresh: float = 0.5,
        ...
        vis_topic = pub_topic + "visualization_traffic" if pub_topic.endswith("/") else \
            pub_topic + "/visualization_traffic"
        ...
        self.img_subscriber = rospy.Subscriber(
            image2, Image, self.process_img_msg
        )
...
if __name__ == "__main__":
    ...
    image2 = rospy.get_param(ns + "image2")
