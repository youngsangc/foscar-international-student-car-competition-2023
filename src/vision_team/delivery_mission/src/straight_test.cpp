...
int main(int argc, char **argv) {
    ...
    while (mode == 10) {
      ...
      if (mission_flag == 0 && is_delivery_obs_stop_detected == 1) {
            mission_flag = 1;
    ...
    while (mode == 20) {
        ...
        ROS_INFO("@@@@@@@@@ is_delivery_obs_stop_detected =%d ", is_delivery_obs_stop_detected);
        ...
        if ((mission_flag == 1 || mission_flag == 2 || mission_flag == 3) && is_delivery_obs_stop_detected == 1) {
            //is_delivery_obs_stop_detected = 0;
