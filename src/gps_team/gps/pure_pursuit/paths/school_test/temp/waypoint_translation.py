...
if __name__ == "__main__":
    ...
    #k_city_start_position = np.array([935575.953392, 1915951.47343, 0],np.float64)
    ...
    school_start_position = np.array([955539.464911, 1956946.01537, 0],np.float64)  # avoid path start point
