...
# Main scene
scene=display(title="HandsFree IMU Main Screen")
...
scene2 = display(title='HandsFree IMU Roll, Pitch, Yaw',x=550, y=0, width=500, height=500,center=(0,0,0), background=(0,0,0))
scene2.range=(1,1,1)
scene2.select()
#Roll, Pitch, Yaw
...
sub = rospy.Subscriber('/handsfree/imu', Imu, processIMU_message)
rospy.spin()
